...
```{r}
game_boxes_with_opp <- read_csv("https://raw.githubusercontent.com/dwillis/hhs-snapshots/main/data/team_gameboxes_opp_20230301.csv")

team_seasons_2023 <- read_csv("https://raw.githubusercontent.com/dwillis/hhs-snapshots/main/data/team_seasons.csv") %>% filter(end_year == 2023)
